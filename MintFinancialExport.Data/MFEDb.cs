...
//     Configuration file:     "MintFinancialExport.Data\App.config"
...
namespace MintFinancialExport.Data
{
    ...
    public class Account
    {
        ...
        /// <summary>
        /// Child AccountHistories where [AccountHistory].[AccountID] point to this entity (FK__AccountHi__Accou__25869641)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<AccountHistory> AccountHistories { get; set; } // AccountHistory.FK__AccountHi__Accou__25869641
        /// <summary>
        /// Child AccountMappings where [AccountMapping].[AccountID] point to this entity (FK__AccountMa__Accou__2A4B4B5E)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<AccountMapping> AccountMappings { get; set; } // AccountMapping.FK__AccountMa__Accou__2A4B4B5E
    ...
    public class AccountHistory
    {
        ...
        /// <summary>
        /// Parent Account pointed by [AccountHistory].([AccountId]) (FK__AccountHi__Accou__25869641)
        /// </summary>
        public virtual Account Account { get; set; } // FK__AccountHi__Accou__25869641
    }
    ...
    public class AccountMapping
    {
        ...
        /// <summary>
        /// Parent Account pointed by [AccountMapping].([AccountId]) (FK__AccountMa__Accou__2A4B4B5E)
        /// </summary>
        public virtual Account Account { get; set; } // FK__AccountMa__Accou__2A4B4B5E
        /// <summary>
        /// Parent AccountType pointed by [AccountMapping].([AccountTypeId]) (FK__AccountMa__Accou__2B3F6F97)
        /// </summary>
        public virtual AccountType AccountType { get; set; } // FK__AccountMa__Accou__2B3F6F97
    }
    ...
    public class AccountType
    {
        ...
        /// <summary>
        /// Child AccountMappings where [AccountMapping].[AccountTypeID] point to this entity (FK__AccountMa__Accou__2B3F6F97)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<AccountMapping> AccountMappings { get; set; } // AccountMapping.FK__AccountMa__Accou__2B3F6F97
    ...
    public class AccountHistoryConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AccountHistory>
    {
        ...
        public AccountHistoryConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.Account).WithMany(b => b.AccountHistories).HasForeignKey(c => c.AccountId).WillCascadeOnDelete(false); // FK__AccountHi__Accou__25869641
        }
    }
    ...
    public class AccountMappingConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AccountMapping>
    {
        ...
        public AccountMappingConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.Account).WithMany(b => b.AccountMappings).HasForeignKey(c => c.AccountId).WillCascadeOnDelete(false); // FK__AccountMa__Accou__2A4B4B5E
            HasOptional(a => a.AccountType).WithMany(b => b.AccountMappings).HasForeignKey(c => c.AccountTypeId).WillCascadeOnDelete(false); // FK__AccountMa__Accou__2B3F6F97
        }
    }
